<template>
  <div class="about-view">
    <!-- Custom afbeelding onder navigatie -->
    <div class="hero-image">
      <img src="/src/assets/wiezijnwij.png" alt="BSO Rooie Noes team" />
    </div>
  ...
  data() {
    return {
      latestNews: [
        {
          id: 1,
          excerpt: 'Uw kind is het waardevolste bezit en als werkende en/of studerende ouder/verzorger zoek je natuurlijk een buitenschoolse opvang die bij u en bij uw kind past.',
          image: 'https://image.oudersvannu.nl/243483486/width/2048/festivals-met-kinderen'
        },
        {
          id: 2,
          excerpt: 'Wij bieden opvang, begeleiding en ondersteuning aan kinderen vanaf de geboorte tot het moment dat ze de basisschool verlaten. Zowel de dagopvang als de buitenschoolse opvang vindt plaats in een ongedwongen en huiselijke sfeer.',
